...
<head>
  ...
  <title>Admin | Pending Affiliates</title>
    ...
    <section class="content" style='overflow-y: auto !important;box-sizing: border-box;'>
      ...
      <div class="card" style="height: 550px;">
        <div class="card-header">
          <h3 class="card-title">Pending Affiliates</h3>
...
<script src="<?php echo getCacheBustedUrl('../scripts/pending-affiliates.js'); ?>" type='module'></script>
</body>
</html>
