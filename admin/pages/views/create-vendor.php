...
<head>
  ...
  <title>Admin | Create Vendor</title>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="vendorCountry"></select>
              </div>
              <div class="row">
                <div class="col-12">
                    <input type="button" id='create-vendor' value="Create Vendor" class="btn btn-success float-left">
...
<script src="<?php echo getCacheBustedUrl('../scripts/create-vendor.js'); ?>" type='module'></script>
</body>
</html>
