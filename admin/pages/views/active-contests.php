...
<head>
  ...
  <title>Admin | Active Contests</title>
...
<body class="hold-transition sidebar-mini" id='<?php echo $adminID; ?>'>
<!-- Site wrapper -->
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Active Contests</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content" style="overflow-y: auto !important;box-sizing: border-box;">
      ...
      <div class="card" style="height: 550px;">
        <div class="card-header">
          <h3 class="card-title">Active Contests</h3>
        ...
        <div class="card-body p-0" style='overflow-x: auto !important;white-space: normal;'>
          <table class="table table-striped projects">
              ...
              <tbody style="overflow-y: auto !important;overflow-x: hidden !important;"></tbody>
          </table>
        </div>
        <!-- /.card-body -->
      </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="#!">fiberearn</a>.</strong> All rights reserved.
  </footer>-->
...
<div id='description-overlay'>
  ...
  <input type="text" id="contestID" value="" hidden>
</div>
...
<script src="<?php echo getCacheBustedUrl('../scripts/active-contests.js'); ?>" type='module'></script>
</body>
</html>
