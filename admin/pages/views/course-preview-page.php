...
<head>
  ...
  <title>Admin | Course Preview</title>
...
<!-- / Main Sidebar Container -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <!-- Default box -->
      <div class="card">
        <div class="card-body p-0" style='display: flex;flex-direction: row;flex-wrap: wrap;padding: 10px !important;overflow-y: auto !important;box-sizing: border-box;height: 550px;'>
                    ...
                    foreach($files as $file){
                        if(is_file("$file")){
                          ...
                          $filename = pathinfo($file, PATHINFO_BASENAME);
                           echo "
                              <div class='content-div'>
                                <img src='../../../assets/img/folder.png' class='sub-folder-image' style='width: 90%;height: 150px;'>
                                <p>$filename</p>
                              </div>
                            ";
                        }
...
$('.sub-folder-image').each(function (index, el) {
    $(el).on('click', function (e) {
        const filePath = $(el).parent().find('p').text();
        const parentFolder = '<?php echo $dir; ?>';
        window.location = `../views/course-sub-folder-view.php?filePath=${filePath}&parentDirectory=${parentFolder}`;
    });
});
