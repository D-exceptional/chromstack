                    ...
                    foreach($files as $file){
                        if(is_file("$file")){
                          ...
                          $filename = pathinfo($file, PATHINFO_BASENAME);
                           echo "
                              <div class='content-div'>
                                <img src='../../../assets/img/folder.png' class='sub-inner-folder-image' style='width: 150px;height: 150px;'>
                                <p>$filename</p>
                              </div>
                            ";
                        }
...
$('.sub-inner-folder-image').each(function (index, el) {
    $(el).on('click', function (e) {
        const filePath = $(el).parent().find('p').text();
        const parentFolder = '<?php echo $fullPath; ?>';
        window.location = `../views/sub-inner-folder-view.php?filePath=${filePath}&parentDirectory=${parentFolder}`;
    });
});
