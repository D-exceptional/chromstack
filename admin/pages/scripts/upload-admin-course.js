...
$(document).ready(function () {
        ...
        if (input.files && input.files[0]) {
          ...
          switch (extension) {
            ...
            case 'jfif':
              ...
              displayInfo('Selected file format not supported.');
    ...
    $('#course-cover-page').on('change', function () {
    ...
    $("#course-upload-form").on("submit", function (event) {
        ...
        if ($('#course-cover-page').val() !== '') {
            if ($('#title').val() !== '' && $('#description').val() !== '' && $('#amount').val() !== '' && $('#page').val() !== '' && $('#commission').val() !== '') {
              //Upload form
              ...
              $.ajax({
                ...
                url: "server/upload-admin-course.php",
                data: data,
                dataType: "json",
                processData: false,
                contentType: false,
