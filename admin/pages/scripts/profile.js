    ...
    $.ajax({
        ...
        for (const key in response) {
            if (Object.hasOwnProperty.call(response, key)) {
                ...
                if (content !== 'Something went wrong' && content !== 'Failed to upload image' && content !== 'Image must have either .jpeg, .png or .jpg extension' && content !== 'Upload a valid image' && content !== 'All fields must be filled up') {
