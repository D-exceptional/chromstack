...
$sql = mysqli_query($conn, "SELECT courseID, course_title, course_description, course_cover_page, course_type, course_status, course_authors, course_amount, admin_percentage, affiliate_percentage, vendor_percentage, uploaded_on, folder_path FROM uploaded_courses");
