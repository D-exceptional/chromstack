...
<body>
                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="./index.php">Dashboard</a></li>
                    ...
                    <form id="course-upload-form">
                        <div class="row g-3">
                            ...
                            <div class="col-12" id="uploadBar" style="display: none;height: 40px;background: #eff1f3;">
                               <div id="progressBar" style="background: green;color: white;text-align: center;transition: 0.5s;width: 0%;height: 100%;display: flex;flex-direction: row;align-items: center;justify-content: center;"></div>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script src="<?php echo getCacheBustedUrl('scripts/upload-main-course.js'); ?>" type="module"></script>
</body>
