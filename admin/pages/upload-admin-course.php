...
<body>
                    ...
                    <form id="course-upload-form">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="file" class="form-control" name="course_cover_page" id='course-cover-page' hidden>
                            </div>
    ...
    <script src="<?php echo getCacheBustedUrl('scripts/upload-admin-course.js'); ?>" type="module"></script>
</body>
