    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <!-- Check incoming mails -->
         ...
         <!-- Check course sales --->
          <?php 
            $sales_count = mysqli_query($conn, "SELECT * FROM general_notifications WHERE notification_type = 'course_sale' AND notification_receiver_email = '$email' AND notification_status = 'Unseen'");
