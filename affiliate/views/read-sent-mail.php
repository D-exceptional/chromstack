<?php 
  ...
  $mail_query = mysqli_query($conn, "SELECT * FROM mailbox WHERE mailID = '$mailID'");
  if(mysqli_num_rows($mail_query) > 0){
    $query_result = mysqli_fetch_assoc($mail_query);
  }
...
<head>
  ...
  <title>Affiliate | Sent Mail</title>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h6>To: <b><?php echo $query_result['mail_receiver']; ?></b>
                  <span class="mailbox-read-time float-right"><?php echo $query_result['mail_date'] .'  '.$query_result['mail_time']; ?></span></h6>
              </div>
              <!-- /.mailbox-read-info -->
              
              <!-- /.mailbox-controls -->
              <div class="mailbox-read-message">
                <p><?php echo $query_result['mail_message']; ?></p>
              </div>
