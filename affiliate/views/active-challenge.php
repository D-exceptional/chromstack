...
<head>
  ...
  <title>Affiliate | Active contests</title>
...
<div class="wrapper">
  ...
  <div id='description-overlay'>
    ...
    <div id='button-div'>
      <button id="<?php echo $affiliateID; ?>">Copy Link</button>
    </div>
    <input type="text" id="contestID" value="" hidden>
    <input type="text" id="contestLink" value="" hidden>
  </div>
...
<script src="<?php echo getCacheBustedUrl('../scripts/active-challenge.js'); ?>" type='module'></script>
</body>
</html>
