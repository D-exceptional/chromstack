<?php
    ...
    $affiliateID = mysqli_real_escape_string($conn, $_POST['id']);
    ...
    if(!empty($_FILES['profile'])){
        ...
        $query = mysqli_query($conn, "SELECT  fullname, affiliate_profile FROM affiliates WHERE affiliateID = '$affiliateID'");
    ...
    if(in_array($img_ext, $extensions) === true){
            ...
            if(move_uploaded_file($tmp_name, $targetDir.$img_name)){ 
                ...
                //Compress the uploaded image and store in database
                ...
                $insert_query = mysqli_query($conn, "UPDATE affiliates SET affiliate_profile = '$new_img_name' WHERE affiliateID = '$affiliateID'");
