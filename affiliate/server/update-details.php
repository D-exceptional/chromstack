<?php
 ...
 require 'conn.php';
    ...
    if(!empty($affiliateID) && !empty($instagram) && !empty($twitter)  && !empty($tiktok) && !empty($facebook)){

      $update_query = mysqli_query($conn, "UPDATE affiliates SET instagram_link = '$instagram', tiktok_link = '$tiktok', twitter_link = '$twitter', facebook_link = '$facebook' WHERE affiliateID = '$affiliateID'");
