  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #181d38 !important;overflow-y: auto;overflow-x: hidden !important;">
    ...
    <div class="sidebar" style="height: 630px;overflow-x: hidden !important;">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php
            if ($row['vendor_profile'] !== 'null') {
                 ...
                 echo "<img src='../../uploads/$image' class='img-circle elevation-2' style='width: 50px !important;height: 50px !important;border: 2px solid #c2c7d0;' alt='User Image'>";
            }
            else {
        ...
        <?php
            if ($row['fullname'] !== 'null') {
                $name = $row['fullname'];
                echo "<a href='../views/settings.php' class='d-block' style='overflow: hidden !important;white-space: nowrap !important;text-overflow: ellipsis !important;'>$name</a>";
              }
               else {
      ...
      <nav class="mt-2">
        ...
        <p id='sessionEmail' style='display: none;'><?php echo $row['email']; ?></p>
        <p id='sessionName' style='display: none;'><?php echo $row['fullname']; ?></p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="https://chat.whatsapp.com/JCiBvLKGRLQ58CnkgUPxBG" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>WhatsApp</p>
                </a>
              </li>
          ...
          <li class="nav-item">
           ...
           <!--<li class="nav-item" id="eLearning">
            <a href="https://www.chromstack.com/eLearning/" class="nav-link">
