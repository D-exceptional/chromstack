<?php 
  ...
  //Get savings if any
  $savings_query = mysqli_query($conn, "SELECT SUM(wallet_amount) AS total_savings FROM wallet WHERE wallet_email = '$email' AND wallet_user = 'Vendor'");
...
<head>
  ...
  <title>Vendor | Weekly Withdrawal</title>
...
<body class="hold-transition sidebar-mini" id='<?php echo $_SESSION['vendorID']; ?>'>
<!-- Site wrapper -->
<div class="wrapper">
