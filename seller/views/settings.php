...
<div class="wrapper">
  <input type="number" name="vendorID" id="vendorID" value="<?php echo $_SESSION['vendorID']; ?>" hidden>
  <!-- Navbar -->
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <?php
                    if ($row['vendor_profile'] !== 'null') {
                        $image = $row['vendor_profile'];
                        echo "<img src='../../uploads/$image' class='profile-user-img img-fluid img-circle' style='width: 100px !important;height: 100px !important;' alt='Vendor Image'>";
                    }
                    else {
                    echo "<img src='../../assets/img/user.png' class='profile-user-img img-fluid img-circle' style='width: 100px !important;height: 100px !important;' alt='Vendor Image'>";
                    }
                ?>
                </div>
                ...
                <?php
                    if ($row['fullname'] !== 'null') {
                        $name = $row['fullname'];
                        echo "<a href='#' class='d-block' style='overflow: hidden !important;white-space: nowrap !important;text-overflow: ellipsis !important;color: #181d38 !important;'>$name</a>";
                      }
                      else {
                        echo "<a href='#' class='d-block' style='overflow: hidden !important;white-space: nowrap !important;text-overflow: ellipsis !important;color: #181d38 !important;'>Vendor</a>";
                      }
                  ?>
                </h3>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="bank">
                    <form class="form-horizontal" id='bank-form'>
                         <input type="number" id="uniqueID" name="vendorID" value="<?php echo $_SESSION['vendorID']; ?>" hidden>
                         <div class="form-group row">
