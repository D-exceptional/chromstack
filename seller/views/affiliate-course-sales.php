...
<head>
  ...
  <title>Vendor | Course Sales</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Course Sales</b></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active">Course Sales</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content" style='overflow-y: auto !important;box-sizing: border-box;'>
      ...
      <div class="card" style="height: 550px;">
        <div class="card-header">
          <h3 class="card-title">Course Sales</h3>
                  ...
                  <?php 
                      ...
                      if(mysqli_num_rows($sql) > 0){
                          ...
                          if (mysqli_num_rows($amount_query) > 0) {
                            ...
                            $total_sales_amount_in_usd = $total_amount_generated / 500;
                          }
                          else {
                          ...
                          if (mysqli_num_rows($total_affiliate_amount_query) > 0) {
                            ...
                            $total_affiliate_sales_amount_in_usd = $total_affiliate_sales_amount / 500;
                          }
                          else {
                          ...
                          while($value = mysqli_fetch_assoc($sales_details_query)){
                            ...
                            if (mysqli_num_rows($unique_affiliate_amount_query) > 0) {
                              ...
                              $unique_affiliate_total_amount_in_usd = $unique_affiliate_total_amount / 500;
                            }
                            else {
                             ...
                             $net_income_in_usd = ($unique_affiliate_total_amount_in_naira * ($affiliate_commission / 100)) / 500;
