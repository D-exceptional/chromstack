...
if(!empty($email) && !empty($subject) && !empty($message)){
    ...
    if(filter_var($email, FILTER_VALIDATE_EMAIL)){
        ...
        $insert_query = mysqli_query($conn, "INSERT INTO mailbox (mail_type, mail_subject, mail_sender, mail_receiver, mail_date, mail_time, mail_message, mail_filename, mail_extension) VALUES ('$type', '$subject', '$name', '$email', '$date', '$time', '$message', 'null', 'null')");
