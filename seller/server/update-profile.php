<?php
    ...
    if(!empty($_FILES['profile'])){
        ...
        $query = mysqli_query($conn, "SELECT vendor_profile FROM vendors WHERE vendorID = '$vendorID'");
    ...
    if(in_array($img_ext, $extensions) === true){
            ...
            if(move_uploaded_file($tmp_name, $targetDir.$img_name)){ 
                ...
                $insert_query = mysqli_query($conn, "UPDATE vendors SET vendor_profile = '$new_img_name' WHERE vendorID = '$vendorID'");
