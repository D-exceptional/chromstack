...
<head>
    <meta charset="utf-8">
    <title>Vendor | Upload Course</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0" style='box-shadow: none !important;'>
        <a href="./index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>chromstack</h2>
        </a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Upload Course</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="index.php">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Vendor Course</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Upload Course</h6>
                <h1 class="mb-5">Provide Course details</h1>
            </div>
            <div class="row g-4">
               <!--<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s"> </div>-->
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <img class="position-relative rounded w-100 h-100" src="../assets/img/background-image.jpg" style="min-height: 300px; border:0;overflow: hidden !important;" />
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="fullname" id='fullname' value='<?php echo $row['fullname']; ?>' placeholder="Fullname">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="contact" id='contact' value='<?php echo $row['contact']; ?>' placeholder="Contact">
                            ...
                            <div class="col-12">
                             ...
                             <div class="col-12">
                                <div class="form-floating" id='file-click' style='height: 50px;padding-top: 10px;padding-left: 10px;border: 1px solid #ced4da;color: #52565b;font-size: 1rem;font-weight: 400;line-height: 1.5;cursor: pointer;'>
                                    <p>Attach file (Zipped Files Only)</p>
                                </div>
                                <input type="file" class="form-control" name="course_main_file" id='course-main-file' hidden>
                            </div>
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit" id="upload">Upload Course</button>
                            </div>
    ...
    <script src="<?php echo getCacheBustedUrl('scripts/upload-course.js'); ?>" type="module"></script>
</body>
