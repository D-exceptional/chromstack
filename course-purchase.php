<?php 
    ...
    //Get details
    $sql = mysqli_query($conn, "SELECT course_title, course_cover_page, course_amount, course_authors, course_description, folder_path, course_narration FROM uploaded_courses WHERE courseID = '$id'");
    ...
    if($folder_path !== 'null'){
        $image = './courses/' . $folder_path . '/' . $row['course_cover_page'];
    }
    else{
         $image = './assets/img/' . $row['course_cover_page'];
    }
    ...
    function generateReference($length = 10) {
        ...
        return 'TXN' . $code . 'ocp'; // Reference pattern for other courses purchase. Tables involved are `uploaded_course_sales` and `uploaded_course_sales_backup`
    }
...
<body>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header" id="top-header-preview" style="background-image: url(<?php echo $image; ?>);">
    ...
    <div class="row g-4" style='display:flex;flex-direction:row;align-items:center;justify-content:center;'>
        <div class="container">
            ...
            <!--<div class="owl-carousel testimonial-carousel position-relative" id="course-review-carousel"></div>-->
        </div>

        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.5s" style="overflow-x: hidden !important;">
            <form id="course-purchase-form" style="overflow-x: hidden !important;">
                <div class="row g-3" style='padding: 0% 2%;'>
                    <div class="col-md-12" id="membership-div">
                        <div class="form-floating">
                            <p style="padding-left: 0.375rem;">Membership Type</p>
                            <select name="membership_type" id="membership-type" style="display: block;width: 100%;height: 50px;padding: 0.375rem 0.75rem;font-size: 1rem;font-weight: 400;line-height: 4;color: #52565b;background-color: #fff;background-clip: padding-box;border: 1px solid #ced4da;border-radius: 0px;transition: border-color 0.15s ease-in-out,box-shadow 0.15s ease-in-out;">
                    ...
                    <div class="col-md-12" id="country-div-one">
                        <div class="form-floating">
                    ...
                    <div class="col-12">
                        <button class="btn btn-primary w-100 py-3" type="button" id="proceed" style="margin-bottom: 20px;">Buy Now</button>
                        <!--<button class="btn btn-primary w-100 py-3" type="button" id="pay" style="margin-bottom: 20px;">Buy Now</button>-->
                    </div>
                </div>
                <p id="status" style="display: none;"></p>
                <p id="user-type" style="display: none;"></p>
    ...
    <div id='payment-modal-overlay'>
        <div class="row g-4">
            ...
            <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.5s" id="paymentDetails">
                <form id="payment-form">
                    <div class="row g-3" style='padding: 0% 2%;'>
                        ...
                        <div class="col-12">
                            ...
                            <button class="btn btn-primary w-100 py-3" type="button" id="hide-continue" style="color: white;display: none;">Buy Now</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script src="<?php echo getCacheBustedUrl('assets/scripts/buy-course.js'); ?>" type="module"></script>
    <!-- Interswitch Payment --
    <script src="https://newwebpay.interswitchng.com/inline-checkout.js"></script>
    <script src="assets/scripts/purchase-courses.js" type="module"></script>-->
