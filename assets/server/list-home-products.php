...
$sql = mysqli_query($conn, "SELECT courseID, course_title, course_cover_page, course_type, course_amount, course_category, course_narration, sales_page, folder_path FROM uploaded_courses WHERE course_title != 'Stellar Publishing Guide' AND course_title != 'Ghostwriting Income Generator'  AND course_status = 'Approved' ORDER BY course_title ASC LIMIT 2");
