...
function send_email($subject, $email, $message) {
    ...
    try {
                                                                                        ...
                                                                                        <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                                                                            <tr>
                                                                                                <th class='column' width='260' style='font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;'>
                                                                                                    <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                                                                                        <tr>
                                                                                                            <td class='fluid-img' style='font-size:0pt; line-height:0pt; text-align:left;'><a href='#'><img src='https://chromstack.com/assets/img/notification.jpg' style='border-radius: 10px;width: 260px;height: 200px !important;' border='0' alt='' /></a></td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                                </th>
            ...
            var_dump("Error occured while course completion mail was being sent");
        }
